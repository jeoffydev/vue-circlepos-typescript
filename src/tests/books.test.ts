...
const mockBooksResponse = {
  data: {
    books: [
      { id: 1, title: 'Test Book 1', author: 'Author 1', isbn: '1234', availableStock: 10, price: 10 },
      { id: 2, title: 'Test Book 2', author: 'Author 2', isbn: '4567', availableStock: 15, price: 15 }
    ]
  }
}
...
const mockBookResponse = {
  data: {
    book: { id: 1, title: 'Test Book 1', author: 'Author 1', isbn: '1234', availableStock: 10, price: 10 }
  }
}
vi.mock('axios', () => {
  const mockGet = vi.fn()
